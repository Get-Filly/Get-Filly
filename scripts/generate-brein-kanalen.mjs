...
/**
 * ============================================================
 * Genereert docs/werking/social-posting-brein-kanalen.md uit
 * filly-brain.config.ts
 * ============================================================
 *
 * Waarom: het social-posting-brein-document
 * (docs/werking/social-posting-brein.docx, voorheen "Timing Brein" /
 ...
 * Output:   docs/werking/social-posting-brein-kanalen.md (overschrijft)
 */
...
lines.push(`(\`docs/werking/social-posting-brein.docx\`, de timing-laag) aan met de lengte-,`);
